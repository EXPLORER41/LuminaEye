...
def load_navigation_models():
    ...
    try:
        ...
        seg_model_path = os.getenv("BLIND_PATH_MODEL", os.path.join(base_dir, "model", "yolo-seg.pt"))
        ...
        obstacle_model_path = os.getenv("OBSTACLE_MODEL", os.path.join(base_dir, "model", "yoloe-11l-seg.pt"))
