...
YOLO_MODEL_PATH = os.getenv("SHOPPING_MODEL_PATH", os.path.join(BASE_DIR, "model", "shoppingbest5.pt"))
HAND_TASK_PATH  = os.getenv("HAND_TASK_PATH", os.path.join(BASE_DIR, "model", "hand_landmarker.task"))
